...
<html lang="en">
  ...
  <body>
    ...
    <div class="modal-body">
		<p>
			Are you sure you'd like to save your portfolio? If you have not made any changes, press Cancel.
		</p>
	</div>
    ...
    <div class="modal-footer">
		<a href="#" class="btn" id="cancelEmpty">Go Back</a>
    </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="row">
          <div class="span11">
			<input type="search" id="searchTextBox" value="Enter Symbol" data-default-value="Enter Symbol"> <button id="finishButton" class="btn success">Save</button> <button class="btn primary" id="refreshPage">Refresh Portfolio</button> <button id="resetPortfolioButton" class="btn error" style="z-index:99999">Empty Portfolio</button>
			<div id="dateTrackerDiv" class="span11">
				<table class="span11" id="preferencesTable">
				<thead>
				<tr><th>Date</th><th>Your Email Address</th><th>Email Frequency</th></tr>
				</thead>
				<tbody>
					<tr>
			...
			<div id="tickerTrackerDiv">
				...
				if(count($Portfolio) == 0) {
					...
					if($Type == "$") {
						...
						print("<tr><td colspan='2' style='text-align:right;'>Total Value</td><td><div class='input-prepend'><span class='add-on btn primary unselectable disabled' style='z-index:0;'>$</span><input id='totalAmountInput' class='span2' type='text' value='".($LastTotal)."'></div></td></tr>");
					}
	...
	<?php
	Presentation::outputFooterNoMenu();
	?>
