...
​
  ...
  <body>
    ...
    <div class="modal-body">
    <script type="text/javascript">
    console.log("in trackTotalModal");
    </script>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="row">
          <div class="span11"><input type="search" id="searchTextBox" value="Enter Symbol" data-default-value="Enter Symbol"> <button id="finishButton" class="btn success">Save Portfolio</button> <button class="btn primary" id="refreshPage">Get Last Portfolio</button> <!--<button id="groupButton" class="btn">Toggle Portfolio View</button> --><button id="resetPortfolioButton" class="btn error">Start New Portfolio</button>
			...
			<div id="tickerTrackerDiv">
				...
				if(count($Portfolio) == 0) {
					...
					foreach($Portfolio as $PortfolioItem) {
						...
						print("</select></td><td><button class='btn primary stockInfo' style='font-size:12px;height:25px; width:25px; padding:0;'>?</button>  <button style='font-size:12px;height:25px; width:25px; padding:0;' class='btn trackStock'>/</button>  <button class='btn error removeStock' style='font-size:12px;height:25px; width:25px; padding:0;'>X</button></td></tr>");
