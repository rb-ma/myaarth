...
{
	//ChromePhp::log($challenge . " " . $response);
	if ($privkey == null || $privkey == '') {
		//ChromePhp::log("invalid private key");
		die ("To use reCAPTCHA you must get an API key from <a href='https://www.google.com/recaptcha/admin/create'>https://www.google.com/recaptcha/admin/create</a>");
	}

	if ($remoteip == null || $remoteip == '') {
		//ChromePhp::log("remote ip problem");
		...
		//ChromePhp::log("ther's no way this shouldn't print");
		...
		//ChromePhp::log($recaptcha_response->error);
		//ChromePhp::log($recaptcha_response->is_valid);
	    return $recaptcha_response;
