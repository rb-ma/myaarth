	...
	<div class="container">
		<div class="content">
			...
			<div style="vertical-align=center;">
				...
				<p style="padding-left:19%; padding-right:0%;padding-top:10%; font-family:Calibri; font-size:30px;">Hold Your Horses!</p>
                <p style="padding-left:19%; padding-right:0%;padding-top:3%; font-family:Calibri; font-size:30px;">Something cool will be here in a bit.</p>
			</div>
		</div>
		<?php
